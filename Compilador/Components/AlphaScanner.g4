...
//llistas
DELMETHOD  : 'del'; // METODO PARA ELIMINAR UN ELEMENTO DE UNA LISTA
ADDMETHOD  : 'add'; // METODO PARA AGREGAR UN ELEMENTO A UNA LISTA
LENMETHOD  : 'len'; // METODO PARA OBTENER EL TAMAÑO DE UNA LISTA

//Casting
CHR : 'chr'; // CASTING DE INT A CHAR
ORD : 'ord'; // CASTING DE CHAR A INT
